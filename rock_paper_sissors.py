...
#for user
    if x == "rock":
        ...
        user_label.configure(image=scissors_img_comp)
...
scissors = Button(root,width=20,height=2,text="SCISSOR",bg="#FF3E4D",fg="white", command= lambda:updateChoice("sissors") ).grid(row=2,column=3) 
